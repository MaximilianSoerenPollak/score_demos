Building the [platform_description](https://github.com/eclipse-score/process_description) documentation, that is heavily linked with [score_platform](https://github.com/eclipse-score/score)
